...
import { zip } from "../types/sequence.ts";
import { TRANSPARENT_CHAR } from "../common/character.ts";
...
import type { LineExtra } from "../style/shape-extra.ts";
import { AnchorChar, type StraightStrokeStyle } from "../style/style.ts";

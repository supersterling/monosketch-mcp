...
import { RectangleBitmapFactory } from "./rectangle-bitmap-factory.ts";
import type { Size } from "../geo/size.ts";
import { MonoBitmap } from "./monobitmap.ts";
import type { TextExtra } from "../style/shape-extra.ts";
import { TextHorizontalAlign, TextVerticalAlign } from "../style/style.ts";

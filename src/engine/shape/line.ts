import { type DirectedPoint, Direction, Point } from "../geo/point.ts";
import { Rect } from "../geo/rect.ts";
import { ShapeExtraManager } from "../style/extra-manager.ts";
import { LineExtra, type ShapeExtra } from "../style/shape-extra.ts";
import { type AbstractSerializableShape, SerializableLine } from "./serialization.ts";
import { AbstractShape } from "./abstract-shape.ts";
import { LineHelper, LineEdge, LineAnchor, type LineAnchorPointUpdate } from "./linehelper.ts";
...
export class Line extends AbstractShape {
    ...
    /**
     * Move start point or end point to new location decided by anchorPointUpdate.
     */
    moveAnchorPoint(

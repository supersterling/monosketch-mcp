...
import { type ShapeExtra, TextExtra } from "../style/shape-extra.ts";
import { type AbstractSerializableShape, SerializableText } from "./serialization.ts";
...
export class Text extends AbstractShape {
    ...
    static fromPoints(startPoint: { left: number; top: number }, endPoint: { left: number; top: number }, id: string | null = null, parentId: string | null = null, isTextEditable: boolean = true): Text {

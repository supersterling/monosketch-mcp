...
import { TextExtra } from "../../../src/engine/style/shape-extra.ts";
import type { SerializableText } from "../../../src/engine/shape/serialization.ts";
import { Text } from "../../../src/engine/shape/text.ts";
